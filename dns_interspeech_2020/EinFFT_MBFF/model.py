...
from audio_zen.model.module.EinFFT import EinFFT
#CUDA_VISIBLE_DEVICES=0
#torchrun --standalone --nnodes=1 --nproc_per_node=1 train.py -C fullsubnet/train.toml
class Model(BaseModel):
    def __init__(
        ...
        self.einfft = EinFFT(dim=self.num_channels * self.num_freqs, num_blocks=self.num_channels)
